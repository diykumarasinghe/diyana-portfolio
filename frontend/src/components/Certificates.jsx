...
const Certificates = () => {
  const certsData = useCMSData('certificates');
        ...
        <div className="space-y-8 max-w-3xl mx-auto">
          {certsData.map((cert, idx) => (
            <div
              ...
              style={{
                boxShadow: '0 0 30px rgba(34,197,94,0.03)',
              }}
            >
              ...
              <div className="flex items-center space-x-4 mb-5 pl-2">
                ...
                <div>
                  ...
                  <h4 className="text-sm font-bold text-[#F8FAFC] mt-0.5">{cert.issuer}</h4>
                </div>
              </div>
