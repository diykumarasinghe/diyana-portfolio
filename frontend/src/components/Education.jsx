        ...
        <div className="max-w-3xl mx-auto relative group">
          ...
          <div className="glass-card rounded-2xl p-8 sm:p-10 relative overflow-hidden transition-all duration-300 hover:border-[#38BDF8]/20 max-w-[720px] mx-auto shadow-2xl">
            ...
            <div className="flex justify-center mb-8">
              <span className="text-xs font-bold text-[#38BDF8] border border-[#38BDF8] px-5 py-2 rounded-full">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center sm:justify-end">
                <span className="bg-[#22C55E]/10 border border-[#22C55E]/20 text-[#22C55E] font-bold text-xs uppercase tracking-widest px-4 py-2 rounded-lg flex items-center space-x-2 shadow-[0_0_15px_rgba(34,197,94,0.15)]">
